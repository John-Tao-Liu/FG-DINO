...
val_dataloader = dict(
    dataset=dict(
        ...
        return_classes=True
        # 限制测试样本数量为500
        # indices=range(500)  # 只测试前500个样本
    ),
    batch_size=1,  # 根据需要调整batch_size
    num_workers=7   # 根据需要调整num_workers
)
...
load_from = '/root/autodl-fs/demo/FG-DINO/tiny.pth'  # 作者 tiny.pth 的绝对路径
